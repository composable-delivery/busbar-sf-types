...
export default function StatsBar({ stats }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 animate-scale-in">
      <Card className="bg-surface text-center p-6 border border-surface-light hover:border-primary-500 transition-all">
      ...
      <Card className="bg-surface text-center p-6 border border-surface-light hover:border-green-500 transition-all">
      ...
      <Card className="bg-surface text-center p-6 border border-surface-light hover:border-purple-500 transition-all">
      ...
      <Card className="bg-surface text-center p-6 border border-surface-light hover:border-blue-500 transition-all">
      ...
      <Card className="bg-surface text-center p-6 border border-surface-light hover:border-orange-500 transition-all">
